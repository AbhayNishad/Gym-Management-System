...
<head>
   ...
   <title>Gym Management | Health Status Entry</title>
  <link rel="stylesheet" href="../../css/style2.css"  id="style-resource-5">
	...
	<style>
     ...
     <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
			...
			<div class="logo">
				<a href="main.php">
					<img src=" ../../image/logo.png" alt="" width="192" height="80" />
				</a>
			</div>
